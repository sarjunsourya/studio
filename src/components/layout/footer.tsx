        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 items-start text-center md:text-left">
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4 inline-block md:block">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="flex items-center justify-center md:justify-start gap-3 text-sm text-muted-foreground transition-all hover:text-primary hover:translate-x-1">
              ...
              <li>
                <Link href="/admin-gate" className="flex items-center justify-center md:justify-start gap-3 text-sm text-muted-foreground transition-all hover:text-primary hover:translate-x-1 mt-4 pt-4 border-t border-white/5">
